...
public class RequerimientoView extends JFrame {
    ...
    public RequerimientoView() {
        ...
        JLabel lbTitulo = new JLabel("--- RETO 5 ---STEVEN CALDERON");
        ...
        btnConsulta1.setBackground(Color.blue);
        ...
        btnConsulta2.setBackground(Color.blue);
        ...
        btnConsulta3.setBackground(Color.blue);
